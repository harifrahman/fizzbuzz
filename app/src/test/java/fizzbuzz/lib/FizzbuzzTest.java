...
class FizzbuzzTest {
    ...
    class General {
        @Test
        void shouldPrintTillNInput() {
            String actual = app.printTill(4);
            assertEquals("1,2,fizz,4", actual);
        }

        @Test
        void shouldPrintTillFive() {
            String actual = app.printTill(5);
            assertEquals("1,2,fizz,4,buzz", actual);
        }

        @Test
        void shouldPrintTillOneHundred() {
            ...
            String actual = app.printTill(100);
    ...
    class FizzBuzzTest {
        @Test
        void shouldPrintFizzIfDivisibleByThree() {
            String actual = app.printTill(5);
            assertEquals("1,2,fizz,4,buzz", actual);
        }

        @Test
        void shouldPrintBuzzIfDivisibleByFive() {
            String actual = app.printTill(5);
            assertEquals("1,2,fizz,4,buzz", actual);
        }

        @Test
        void shouldPrintFizzBuzzIfDivisibleByFiveAndThree() {
            String actual = app.printTill(15);
